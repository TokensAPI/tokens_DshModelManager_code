...
```sh
npx -y @deepseek-ai/dsh plugin --profile web add @tokens/dsh-model-manager@0.2.17
```
...
```sh
npx -y @deepseek-ai/dsh plugin --profile <name> add @tokens/dsh-model-manager@0.2.17
```
